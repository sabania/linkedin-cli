...
1. All posts in data/posts/ with missing snapshots or without "Analyzed" status
2. For each: Run analysis
3. At the end: Pattern refresh across all archived posts
...
3. Update pattern files in data/patterns/
...
3. Update ICP files in data/icp/
4. Show delta
